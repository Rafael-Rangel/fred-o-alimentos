...
import { ArrowRight, Heart, Users, TrendingUp, Sparkles, ShoppingCart, Loader2, Clock } from "lucide-react";
...
const Index = () => {
  ...
  const diferenciais = [
    { icon: Sparkles, title: "Inovação de Produtos", description: "Novos produtos constantes pensando em você." },
